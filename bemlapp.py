...
if file1 is not None and file2 is not None and file3 is not None:
    ...
    st.write("Please wait..your file is being generated 😁")
    ...
    st.write(gr_pending)
    if st.button('Download GR PENDING as Excel Sheet'):
        tmp_download_link = download_link(gr_pending, 'gr_pending.xlsx', 'Click here to download your data!')
